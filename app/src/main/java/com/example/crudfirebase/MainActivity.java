...
public class MainActivity extends AppCompatActivity {
    ...
    EditText etNombre, etAPaterno, etAMaterno, etSexo, etDireccion, etTelefono, etFecha, etEspecialidad;
    FloatingActionButton fabGuardar, fabListar;

    ProgressDialog progressDialog;

    FirebaseFirestore db = FirebaseFirestore.getInstance();
    String updateId, updateNombre, updateApaterno, updateAmaterno, updateSexo, updateDireccion, updateTelefono, updateFecha, updateEspecialidad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            updateEspecialidad = bundle.getString("updateEspecialidad");
            ...
            etEspecialidad.setText(updateEspecialidad);
        ...
        fabGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bundle1 != null) {
                    ...
                    actualizarDatos(id, nombre, apaterno, amaterno, sexo, direccion, telefono, fecha, especialidad);
                    ...
                    cargarDatos(nombre, apaterno, amaterno, sexo, direccion, telefono, fecha, especialidad);
                }
            }
        });
    ...
    private void cargarDatos(String nombre, String apaterno, String amaterno, String sexo, String direccion, String telefono, String fecha, String especialidad) {
        ...
        doc.put("fecha", fecha);
        doc.put("especialidad", especialidad);
    ...
    private void actualizarDatos(String id, String nombre, String apaterno, String amaterno, String sexo, String direccion, String telefono, String fecha, String especialidad) {
